...
namespace Invector.CharacterController
{
    ...
    {
        public static vThirdPersonInput instance { get; set; }
        ...
        public KeyCode useMouseInput = KeyCode.LeftAlt;
        public static KeyCode interactInput = KeyCode.E;
        public GameObject OverworldMusicObject;
        public static GameObject StaticOMO;
        public AudioClip[] _audioClips;
        public static AudioClip[] StaticAudio;
        public static int _audioIndex = 0;
        ...
        {
            CharacterInit();
            StaticOMO = OverworldMusicObject;
            StaticAudio = _audioClips;
        }
        ...
        {
            // just an example to quit the application 
